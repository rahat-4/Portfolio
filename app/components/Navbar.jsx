...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full fixed flex justify-between items-center py-4 px-5 lg:px-8 xl:px-[8%] z-50">
        <a href="#top">
          <Image
            src={assets.logo}
            alt="logo"
        ...
        <ul
          ref={sideMenuRef}
          className="md:hidden flex flex-col gap-4 py-20 px-10 bg-rose-50 fixed top-0 bottom-0 -right-64 w-64 h-screen z-50 transition duration-500"
        >
